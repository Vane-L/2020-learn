...
@Slf4j
@Component
public class MyLoadBalancerCacheListener implements ApplicationRunner {
    ...
    public void setContext(ConfigurableApplicationContext context) {
        ...
        ObjectProvider<LoadBalancerCacheManager> cacheManagerProvider = this.context.getBeanProvider(LoadBalancerCacheManager.class);
        loadBalancerCacheManager = cacheManagerProvider.getIfAvailable();
    }
    ...
    private void clearCache(String dataStr) {
        ...
        log.info(">>>" + dataStr);
        Optional.ofNullable(getAsJsonObject(dataStr, "name")).map(JsonNode::textValue).ifPresent(cache::evict);
    }
