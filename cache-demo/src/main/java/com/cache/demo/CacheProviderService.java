...
public interface CacheProviderService {
     ...
     **/
    <T extends Object, M extends Object> T get(String key, Function<M, T> function, M funcParam);
     ...
     * @param expireTime 过期时间（单位：毫秒） 可为空
     **/
    <T extends Object, M extends Object> T get(String key, Function<M, T> function, M funcParam, Long expireTime);
