...
public class ReadExcelEnglish {
    ...
    private static MsgTplReqDTO convertRowToData2(Row row) {
        ...
        if (StringUtils.isNotEmpty(convertCellValueToString(row.getCell(7)))) { // pn
            ...
            pnTpl.setType(1);
            pnTpl.setTitle(convertCellValueToString(row.getCell(22)));
            pnTpl.setContent(convertCellValueToString(row.getCell(24)).replace("\n", " "));
        ...
        if (StringUtils.isNotEmpty(convertCellValueToString(row.getCell(8)))) { // ar
            ...
            arTpl.setTitle(convertCellValueToString(row.getCell(16)));
            arTpl.setContent(convertCellValueToString(row.getCell(18)).replace("\n", " "));
        ...
        if (StringUtils.isNotEmpty(convertCellValueToString(row.getCell(10)))) { // sms
            ...
            smsTpl.setType(1);
            smsTpl.setContent(convertCellValueToString(row.getCell(13)).replace("\n", " "));
